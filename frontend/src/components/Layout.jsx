      ...
      <header className="fixed top-0 left-0 right-0 h-16 glass-dark z-50" data-testid="header">
        <div className="flex items-center justify-between h-full px-4 lg:px-6">
          <div className="flex items-center gap-4">
            ...
            {/* Logo */}
            <Link to="/dashboard" data-testid="app-logo-link">
        ...
        {(isSidebarOpen || isMobileMenuOpen) && (
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-white/5">
              <button
                onClick={() => { setIsMobileMenuOpen(false); navigate('/timeline?status=Finalizado'); }}
                className="w-full text-left card-obsidian-interactive p-4"
                data-testid="sidebar-active-shortcut"
                title="Ver licenças ativas na Timeline"
              >
